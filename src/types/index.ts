...
export interface Course { id:string; slug:string; title:string; category:string; lessons:number; duration:string; difficulty:string; instructor:string; progress:number; status:CourseStatus; certificate?:boolean; description:string; image:string }

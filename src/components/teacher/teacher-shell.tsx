...
import { BookOpen, CalendarDays, ClipboardCheck, Home, Landmark, Menu, Users, X } from "lucide-react";
...
const sections = [
  ...
  { href: "/teacher/assessments", label: "Tests", Icon: ClipboardCheck },
  { href: "/teacher/question-bank", label: "Question Bank", Icon: Landmark },
  { href: "/teacher/content", label: "Videos & Materials", Icon: BookOpen },
] as const;

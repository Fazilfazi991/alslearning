...
describe("progressive question bank shell",()=>{
 ...
 it("denies the author shell to a Student",()=>{const html=renderToStaticMarkup(<AuthorIdentityProvider value={{id:"student",role:"student"}}><QuestionBank/></AuthorIdentityProvider>);expect(html).toContain("Author access required");expect(html).not.toContain("Add question");});
});
